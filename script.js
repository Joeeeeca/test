// Declare popupOverlay, emailSection, and embeddedForm globally
var popupOverlay;
var emailSection;
var embeddedForm;
var thankYouMessage;
var embeddedFormResult1
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Retrieve popup overlay, email subscription section elements, and embedded form
  ...
  embeddedFormResult1 = document.getElementById("subscribe-result1");
  ...
  // Subscribe button click event listener for the popup form
document.getElementById("subscribe-form").addEventListener("submit", function () {
  // Hide both forms because the class signup-form is on both forms
  ...
  // Hide the form container within the email subscription section
  var formContainer = document.querySelector(".email-subscription-section .form-container");
  if (formContainer) {
...
// Add event listener to the subscription form on the page
...
function submitSubscribeForm($form, $resultElement) {
  ...
  if (emailSection) {
      embeddedForm.style.display = "block";
    embeddedFormResult1.style.border = "1px solid orange";
  }



              // Show the "Thank You For Subscribing" message
              var thankYouMessage = $("<div></div>").text("Thank You For Subscribing").css("border", "1px solid orange");
              $("#subscribe-result1").append(thankYouMessage);
          } else {
              var thankYouMessage = $("<div></div>").text("Thank You For Subscribing").css("color", "black");
              $resultElement.html(thankYouMessage);

              // Add countdown
              var countdown = 3;
              var countdownElement = $("<div></div>").css("color", "black").appendTo($resultElement);
              var countdownInterval = setInterval(function() {
                  if (countdown > 0) {
                      countdownElement.text("Window Closing in " + countdown);
                      countdown--;
                  } else {
...
function submitSubscribeForm($form, $resultElement) {
  ...
  if (emailSection) {
      embeddedForm.style.display = "block";
              ...
              // Show the "Thank You For Subscribing" message
              var thankYouMessage = $("<div></div>").text("Thank You For Subscribing").css("color", "black");
              $(".email-subscription-section").append(thankYouMessage);
          } else {
              var thankYouMessage = $("<div></div>").text("Thank You For Subscribing").css("color", "black");
              $resultElement.html(thankYouMessage);
