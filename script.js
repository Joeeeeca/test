...
document.getElementById("subscribe-form").addEventListener("submit", function () {
  ...
  // Hide the form groups within the email subscription section
  var formGroups = document.querySelectorAll(".email-subscription-section .form-group");
  formGroups.forEach(function(formGroup) {
      formGroup.style.display = "none";
  });

  // Hide the submit button
  var submitButton = document.getElementById("subscribe-result1");
